...
public class main {
	public static void main(String[] args) {
		...
		System.out.println("Tên hãng sản xuất BP 3: "+boPhim3.getTenPhim());
		
		boPhim1.tenHangSanXuat();
		boPhim2.tenHangSanXuat();
	
		System.out.println("BP1 giam 10%: "+ boPhim1.giaVeSauKhiGiam(10));
		System.out.println("BP2 giam 20%: "+ boPhim2.giaVeSauKhiGiam(20));
		System.out.println("BP3 giam 50%: "+ boPhim3.giaVeSauKhiGiam(50));
	}
}
