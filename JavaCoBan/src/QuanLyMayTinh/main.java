...
public class main {
	public static void main(String[] args) {
		...
		System.out.println("M1 < M2: "+ mayTinh1.KiemTraGiaBan(mayTinh2));
		System.out.println("M1 < M3: "+ mayTinh1.KiemTraGiaBan(mayTinh3));
		
		
		System.out.println("Tên quốc gia: ");
		System.out.println("M1: "+ mayTinh1.TenQuocGiaSanXuat());
		System.out.println("M2: "+ mayTinh2.TenQuocGiaSanXuat());
		System.out.println("M3: "+ mayTinh3.TenQuocGiaSanXuat());
	}
}
